  ...
  <div class="relative z-10 max-w-6xl mx-auto min-h-screen flex flex-col justify-center pb-10">
    ...
    <div class="w-full">
      <div class="flex flex-col mb-10">
        <h1 class="text-[48pt] md:text-[100px] lg:text-[150px] font-bold text-secondary leading-none">
          Front-end
        </h1>
        <h1 class="text-[48pt] md:text-[100px] lg:text-[150px] text-right font-bold text-secondary leading-none">
          Developer
        </h1>
      </div>
    ...
    <div class="lg:hidden mt-32 flex justify-center">
      <NuxtLink to="">
